    ...
    <form method="POST" action="{{ route('gestion.utilisateurs.update', $user) }}" class="card shadow-sm">
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-12">
                    <label class="form-label fw-semibold">Nouveau mot de passe provisoire</label>
            ...
            <div class="d-flex gap-2 mt-4">
                ...
                <a href="{{ route('gestion.utilisateurs.index') }}" class="btn btn-outline-secondary">Annuler</a>
            </div>
        </div>
    </form>
</div>
