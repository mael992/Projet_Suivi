...
<div class="container py-4" style="max-width:680px;">
    ...
    <h1 class="h4 mb-1">Ajouter un commerçant — {{ $mairie->nom }}</h1>
    ...
    <form method="POST" action="{{ route('marche.commercants.store') }}" class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <div class="d-flex gap-2 mt-4">
                <button type="submit" class="btn btn-primary">Créer le commerçant</button>
                <a href="{{ route('marche.commercants', request()->only('mairie')) }}" class="btn btn-outline-secondary">Annuler</a>
            </div>
        </div>
    </form>
</div>
